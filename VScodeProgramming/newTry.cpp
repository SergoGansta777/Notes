...
int main()
{
    ...
    cout << "Введите количество комнат вдоль восточной стены(количество строчек в таблице): ";
    cin >> N;
    cout << "Введите количество комнат вдоль северной стены(количество столбцов в таблице): ";
    cin >> M;
